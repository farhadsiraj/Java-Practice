...
public class Delimiters {
    public static void main(String[] args) {
        ...
        // The scan.nextLine() trap occurs when you put it after
        // scan.nextInt(), nextLong(), nextDouble(), or next()
        // The solution is to add a throwaway nextLine() to capture the empty space
        // after whatever is collected by the previous next____()
    }
}
